                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                ...
                                <x-ui.card.description>Semua jadwal keberangkatan yang terdaftar dalam
                                    sistem</x-ui.card.description>
                            </div>
                                ...
                                <form method="GET" action="{{ route('admin/jadwal.index') }}"
                                    ...
                                    <div class="flex flex-row gap-2">
                                        <div class="relative flex-1 min-w-0">
                                            ...
                                            <x-ui.input type="text" name="search"
            ...
            <x-ui.card.content class="p-0 sm:p-6">
                        ...
                        <x-ui.table>
                            ...
                            <x-ui.table.body>
                                @foreach($jadwals as $index => $jadwal)
                                    <x-ui.table.row>
                                        <x-ui.table.cell
                                            class="font-medium text-xs sm:text-sm">{{ $jadwals->firstItem() + $index }}</x-ui.table.cell>
                                        <x-ui.table.cell>
                                        ...
                                        <x-ui.table.cell>
                                            <div class="flex items-center gap-1 text-sm">
                                                <span
                                                    class="font-medium">{{ $jadwal->rute->asalTerminal->nama_terminal ?? '-' }}</span>
                                                <i data-lucide="arrow-right" class="h-3 w-3 text-muted-foreground shrink-0"></i>
                                                <span
                                                    class="font-medium">{{ $jadwal->rute->tujuanTerminal->nama_terminal ?? '-' }}</span>
                                            </div>
                                        ...
                                        <x-ui.table.cell class="hidden lg:table-cell">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium">{{ $jadwal->tanggal_berangkat->format('d M Y') }}
                                                    </p>
                                                    <p class="text-xs text-muted-foreground">
                                                        {{ $jadwal->jam_berangkat->format('H:i') }} WIB</p>
                                                </div>
                                            </div>
                                        </x-ui.table.cell>
                                        ...
                                        <x-ui.table.cell class="text-right">
                                            <div class="flex items-center justify-end gap-1">
                                                ...
                                                <div x-data="{ open: false }">
                                                    <x-ui.button @click="open = true" variant="ghost" size="icon"
                ...
                @else
                    <div class="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p class="text-sm text-muted-foreground mb-6">Mulai dengan menambahkan jadwal keberangkatan pertama
                            Anda.</p>
                ...
                <x-ui.card.footer class="border-t pt-4">
                    <div class="w-full flex items-center justify-between">
                        <p class="text-sm text-muted-foreground">
                            Menampilkan {{ $jadwals->firstItem() ?? 0 }} - {{ $jadwals->lastItem() ?? 0 }} dari
