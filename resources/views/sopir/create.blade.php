    ...
    <div class="p-4 sm:p-6">
        <div class="max-w-4xl mx-auto">
            <x-ui.card>
                <x-ui.card.header>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <x-ui.card.description>Masukkan detail informasi sopir yang akan ditambahkan</x-ui.card.description>
                        </div>
                ...
                <x-ui.card.content>
                    <form method="POST" action="{{ route('admin/sopir.store') }}" id="sopirForm">
                        @csrf
